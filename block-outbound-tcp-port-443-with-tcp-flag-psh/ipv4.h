...
inline VOID SetIPv4HeaderSrcAddrByUInt32(PIPV4_HEADER header, ULONG src_addr) {
	header->SrcAddress.AddressUInt32 = src_addr;
}
...
inline VOID SetIPv4HeaderDestAddrByUInt32(PIPV4_HEADER header, ULONG dest_addr) {
	header->DestAddress.AddressUInt32 = dest_addr;
}
